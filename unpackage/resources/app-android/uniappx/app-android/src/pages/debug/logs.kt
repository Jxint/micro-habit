        ...
        var setup: (__props: GenPagesDebugLogs) -> Any? = fun(__props): Any? {
            ...
            fun gen_refresh_fn(): Unit {
                ...
                try {
                    ...
                    console.error("[debug] countCompletedToday error: " + e)
                ...
                try {
                    ...
                    console.error("[debug] countSkippedToday error: " + e)
