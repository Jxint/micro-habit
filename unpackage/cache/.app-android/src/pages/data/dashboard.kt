            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "page"), _uA(
                    ...
                    _cE("scroll-view", _uM("class" to "scroll-area", "scroll-y" to "true"), _uA(
                        ...
                        _cE("view", _uM("class" to "section"), _uA(
                            ...
                            _cE("view", _uM("class" to "section-body"), _uA(
                                ...
                                _cE("view", _uM("class" to "chart-container"), _uA(
                                    _cE("text", _uM("class" to "chart-label"), "今天哪些时刻点亮了星球"),
                                    _cV(unref(GenComponentsBarChartClass), _uM("labels" to unref(hourlyLabels), "values" to unref(hourlyValues), "height" to 220, "barColor" to "#CBB8FF"), null, 8, _uA(
                                        "labels",
                                        "values"
                                    ))
                                )),
                        ...
                        _cE("view", _uM("class" to "section"), _uA(
                            _cE("view", _uM("class" to "section-header"), _uA(
                                _cE("text", _uM("class" to "section-title"), "三颗星球趋势")
                            )),
                            _cE("view", _uM("class" to "section-body"), _uA(
                                _cE("view", _uM("class" to "chart-container"), _uA(
