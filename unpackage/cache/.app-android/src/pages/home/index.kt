        ...
        var setup: (__props: GenPagesHomeIndex) -> Any? = fun(__props): Any? {
            ...
            fun gen_refreshSeenSet_fn(): Unit {
                try {
                    ...
                    val arr = UTSAndroid.consoleDebugError(JSON.parse(raw), " at pages/home/index.uvue:317") as UTSArray<Any>
                    val s = Set<String>()
                    if (arr != null) {
                        run {
                            var i: Number = 0
                ...
                try {
                    uni__on("showTriggerRuleDialog", fun(data: Any): Unit {
                        try {
                            ...
                            val rule = UTSAndroid.consoleDebugError(JSON.parse(ruleStr), " at pages/home/index.uvue:738") as EffectiveTriggerRule
                            if (rule == null) {
                                return
                            }
                            ...
                            console.warn("[home] showTriggerRuleDialog 处理异常: " + JSON.stringify(e), " at pages/home/index.uvue:745")
                        }
                    }
                    )
                }
                 catch (e: Throwable) {
                    console.warn("[home] \$on showTriggerRuleDialog 异常: " + JSON.stringify(e), " at pages/home/index.uvue:749")
                }
                try {
                    uni__on("pendingAchievementUnlock", fun(data: Any): Unit {
                        try {
                            ...
                            val ids = UTSAndroid.consoleDebugError(JSON.parse(idsStr), " at pages/home/index.uvue:760") as UTSArray<Any>
                            ...
                            console.warn("[home] pendingAchievementUnlock 异常: " + JSON.stringify(e), " at pages/home/index.uvue:774")
                        }
                    }
                    )
                }
                 catch (e: Throwable) {
                    console.warn("[home] \$on pendingAchievementUnlock 异常: " + JSON.stringify(e), " at pages/home/index.uvue:778")
                }
            }
            )
            onUnload(fun(): Unit {
