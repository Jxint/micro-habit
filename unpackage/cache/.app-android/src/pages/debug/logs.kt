        ...
        var setup: (__props: GenPagesDebugLogs) -> Any? = fun(__props): Any? {
                ...
                run {
                    ...
                    while(i < KNOWN_TABLES.length){
                        ...
                        try {
                            ...
                            console.error("[debug] loadDbOverview count error for " + t + ": " + e, " at pages/debug/logs.uvue:329")
            ...
            fun gen_refresh_fn(): Unit {
                try {
                    ...
                    console.log("[debug] triggerLogs count=" + triggerLogs.value.length, " at pages/debug/logs.uvue:378")
                }
                 catch (e: Throwable) {
                    console.error("[debug] getTodayTriggerLogs error: " + e, " at pages/debug/logs.uvue:380")
                    triggerLogs.value = _uA()
                }
                try {
                    actionLogs.value = getTodayLogs()
                    console.log("[debug] actionLogs count=" + actionLogs.value.length, " at pages/debug/logs.uvue:385")
                }
                 catch (e: Throwable) {
                    console.error("[debug] getTodayLogs error: " + e, " at pages/debug/logs.uvue:387")
                ...
                try {
                    ...
                    console.error("[debug] countCompletedToday error: " + e, " at pages/debug/logs.uvue:390")
                ...
                try {
                    ...
                    console.error("[debug] countSkippedToday error: " + e, " at pages/debug/logs.uvue:391")
            ...
            onPageShow(fun(){
                console.log("[debug] onPageShow firing refresh", " at pages/debug/logs.uvue:405")
                refresh()
            }
            )
            return fun(): Any? {
