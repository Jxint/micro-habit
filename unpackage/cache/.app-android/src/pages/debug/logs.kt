        ...
        var setup: (__props: GenPagesDebugLogs) -> Any? = fun(__props): Any? {
                ...
                run {
                    ...
                    while(i < KNOWN_TABLES.length){
                        ...
                        try {
                            ...
                            console.error("[debug] loadDbOverview count error for " + t + ": " + e, " at pages/debug/logs.uvue:338")
            ...
            fun gen_refresh_fn(): Unit {
                try {
                    ...
                    console.log("[debug] triggerLogs count=" + triggerLogs.value.length, " at pages/debug/logs.uvue:387")
                }
                 catch (e: Throwable) {
                    console.error("[debug] getTodayTriggerLogs error: " + e, " at pages/debug/logs.uvue:389")
                    triggerLogs.value = _uA()
                }
                try {
                    actionLogs.value = getTodayLogs()
                    console.log("[debug] actionLogs count=" + actionLogs.value.length, " at pages/debug/logs.uvue:394")
                }
                 catch (e: Throwable) {
                    console.error("[debug] getTodayLogs error: " + e, " at pages/debug/logs.uvue:396")
                ...
                try {
                    ...
                    console.error("[debug] countCompletedToday error: " + e, " at pages/debug/logs.uvue:399")
                ...
                try {
                    ...
                    console.error("[debug] countSkippedToday error: " + e, " at pages/debug/logs.uvue:400")
            ...
            onPageShow(fun(){
                console.log("[debug] onPageShow firing refresh", " at pages/debug/logs.uvue:418")
                refresh()
            }
            )
            return fun(): Any? {
