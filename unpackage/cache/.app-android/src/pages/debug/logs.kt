        ...
        var setup: (__props: GenPagesDebugLogs) -> Any? = fun(__props): Any? {
                ...
                run {
                    ...
                    while(i < KNOWN_TABLES.length){
                        ...
                        try {
                            ...
                            console.error("[debug] loadDbOverview count error for " + t + ": " + e, " at pages/debug/logs.uvue:249")
            ...
            fun gen_refresh_fn(): Unit {
                try {
                    ...
                    console.log("[debug] triggerLogs count=" + triggerLogs.value.length, " at pages/debug/logs.uvue:298")
                }
                 catch (e: Throwable) {
                    console.error("[debug] getTodayTriggerLogs error: " + e, " at pages/debug/logs.uvue:300")
                    triggerLogs.value = _uA()
                }
                try {
                    actionLogs.value = getTodayLogs()
                    console.log("[debug] actionLogs count=" + actionLogs.value.length, " at pages/debug/logs.uvue:305")
                }
                 catch (e: Throwable) {
                    console.error("[debug] getTodayLogs error: " + e, " at pages/debug/logs.uvue:307")
                ...
                try {
                    ...
                    console.error("[debug] countCompletedToday error: " + e, " at pages/debug/logs.uvue:310")
                ...
                try {
                    ...
                    console.error("[debug] countSkippedToday error: " + e, " at pages/debug/logs.uvue:311")
            ...
            onPageShow(fun(){
                console.log("[debug] onPageShow firing refresh", " at pages/debug/logs.uvue:325")
                refresh()
            }
            )
            return fun(): Any? {
