    ...
    companion object {
        ...
        var setup: (__props: GenPagesSettingsIndex) -> Any? = fun(__props): Any? {
            ...
            fun gen_formatCondition_fn(json: String): String {
                ...
                try {
                    val obj = UTSAndroid.consoleDebugError(JSON.parse(json), " at pages/settings/index.uvue:290") as UTSJSONObject
                    if (obj == null) {
                ...
                try {
                    uni_showModal(ShowModalOptions(title = "确认重置", content = "清空所有成就解锁记录，重新开始统计。", success = fun(res){
                        try {
                            ...
                            console.warn("[settings] resetAchievements 回调异常: " + JSON.stringify(e), " at pages/settings/index.uvue:381")
                        }
                    }
                    ))
                }
                 catch (e: Throwable) {
                    console.warn("[settings] resetAchievements 异常: " + JSON.stringify(e), " at pages/settings/index.uvue:386")
                }
            }
            ...
            fun gen_onManualTrigger_fn(): Unit {
                try {
                    ...
                    console.warn("[settings] manualTrigger 异常: " + JSON.stringify(e), " at pages/settings/index.uvue:414")
                }
            }
            ...
            fun gen_onTriggerEnabledChange_fn(e: Any): Unit {
                try {
                    ...
                    console.warn("[settings] onTriggerEnabledChange 异常: " + JSON.stringify(err), " at pages/settings/index.uvue:444")
                }
            }
            ...
            fun gen_onLlmEnabledChange_fn(e: Any): Unit {
                try {
                    ...
                    console.warn("[settings] onLlmEnabledChange 异常: " + JSON.stringify(err), " at pages/settings/index.uvue:455")
                }
            }
            ...
            fun gen_onAskEachTimeChange_fn(e: Any): Unit {
                try {
                    ...
                    console.warn("[settings] onAskEachTimeChange 异常: " + JSON.stringify(err), " at pages/settings/index.uvue:466")
                }
            }
