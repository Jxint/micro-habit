...
open class GenComponentsLlmHistoryCard : VueComponent {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("history-card" to _pS(_uM("backgroundColor" to "#FFFFFF", "marginTop" to 8, "marginRight" to 16, "marginBottom" to 8, "marginLeft" to 16, "borderTopLeftRadius" to 12, "borderTopRightRadius" to 12, "borderBottomRightRadius" to 12, "borderBottomLeftRadius" to 12, "paddingTop" to 12, "paddingRight" to 12, "paddingBottom" to 12, "paddingLeft" to 12)), "history-header" to _pS(_uM("flexDirection" to "row", "alignItems" to "center", "paddingTop" to 4, "paddingRight" to 4, "paddingBottom" to 4, "paddingLeft" to 4)), "history-title" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "fontSize" to 14, "fontWeight" to "bold", "color" to "#2C3E50")), "history-count" to _pS(_uM("fontSize" to 12, "color" to "#95A5A6", "marginRight" to 8)), "history-arrow" to _pS(_uM("fontSize" to 12, "color" to "#95A5A6")), "history-list" to _pS(_uM("marginTop" to 8)), "history-empty" to _pS(_uM("paddingTop" to 16, "paddingRight" to 16, "paddingBottom" to 16, "paddingLeft" to 16, "alignItems" to "center")), "history-empty-text" to _pS(_uM("fontSize" to 12, "color" to "#95A5A6")), "history-item" to _pS(_uM("paddingTop" to 8, "paddingRight" to 4, "paddingBottom" to 8, "paddingLeft" to 4, "borderBottomWidth" to 1, "borderBottomColor" to "#ECF0F1", "borderBottomStyle" to "solid", "flexDirection" to "column", "borderBottomWidth:last-child" to 0)), "history-item-header" to _pS(_uM("flexDirection" to "row", "alignItems" to "center", "marginBottom" to 4)), "history-stage" to _pS(_uM("fontSize" to 10, "fontWeight" to "bold", "paddingTop" to 2, "paddingRight" to 6, "paddingBottom" to 2, "paddingLeft" to 6, "borderTopLeftRadius" to 3, "borderTopRightRadius" to 3, "borderBottomRightRadius" to 3, "borderBottomLeftRadius" to 3, "marginRight" to 6)), "stage-pre" to _pS(_uM("backgroundColor" to "#E8F5E9", "color" to "#2E7D32")), "stage-post" to _pS(_uM("backgroundColor" to "#E3F2FD", "color" to "#1565C0")), "history-time" to _pS(_uM("fontSize" to 11, "color" to "#95A5A6")), "history-adhoc" to _pS(_uM("fontSize" to 12, "color" to "#34495E", "lineHeight" to 1.5, "marginBottom" to 4)), "history-reasoning" to _pS(_uM("fontSize" to 12, "color" to "#34495E", "lineHeight" to 1.5, "marginBottom" to 4)), "history-rule" to _pS(_uM("backgroundColor" to "#F8F9FA", "borderTopLeftRadius" to 6, "borderTopRightRadius" to 6, "borderBottomRightRadius" to 6, "borderBottomLeftRadius" to 6, "paddingTop" to 6, "paddingRight" to 8, "paddingBottom" to 6, "paddingLeft" to 8, "marginTop" to 4)), "history-rule-label" to _pS(_uM("fontSize" to 10, "color" to "#95A5A6", "marginBottom" to 2)), "history-rule-content" to _pS(_uM("fontSize" to 12, "color" to "#2C3E50", "fontWeight" to "bold")))
            }
