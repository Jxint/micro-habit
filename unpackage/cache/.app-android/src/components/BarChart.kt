...
open class GenComponentsBarChart : VueComponent {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("chart-wrapper" to _pS(_uM("flexDirection" to "column", "width" to "100%", "backgroundColor" to "rgba(0,0,0,0)", "borderTopLeftRadius" to 10, "borderTopRightRadius" to 10, "borderBottomRightRadius" to 10, "borderBottomLeftRadius" to 10, "paddingTop" to 8, "paddingRight" to 4, "paddingBottom" to 4, "paddingLeft" to 4)), "chart-title" to _pS(_uM("paddingTop" to 0, "paddingRight" to 12, "paddingBottom" to 4, "paddingLeft" to 12)), "chart-title-text" to _pS(_uM("fontSize" to 13, "fontWeight" to "bold", "color" to "#FFFFFF")), "chart-scroll" to _pS(_uM("width" to "100%", "flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%")), "chart-row" to _pS(_uM("flexDirection" to "row", "alignItems" to "flex-end", "height" to "100%")), "bar-col" to _pS(_uM("width" to 24, "flexShrink" to 0, "flexDirection" to "column", "alignItems" to "center", "justifyContent" to "flex-end", "marginTop" to 0, "marginRight" to 1, "marginBottom" to 0, "marginLeft" to 1)), "bar-value-row" to _pS(_uM("height" to 14, "alignItems" to "center", "justifyContent" to "center")), "bar-value-text" to _pS(_uM("fontSize" to 8, "color" to "rgba(255,255,255,0.72)")), "bar-track" to _pS(_uM("width" to "100%", "height" to 180, "flexDirection" to "column", "justifyContent" to "flex-end", "alignItems" to "stretch")), "bar-fill" to _pS(_uM("width" to "70%", "alignSelf" to "center", "borderTopLeftRadius" to 3, "borderTopRightRadius" to 3, "minHeight" to 1)), "bar-label-row" to _pS(_uM("height" to 20, "alignItems" to "center", "justifyContent" to "center")), "bar-label-text" to _pS(_uM("fontSize" to 8, "color" to "rgba(255,255,255,0.58)")))
            }
