...
open class GenComponentsEncourageToast : VueComponent {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("toast-overlay" to _pS(_uM("position" to "fixed", "top" to 0, "left" to 0, "right" to 0, "bottom" to 0, "justifyContent" to "center", "alignItems" to "center", "backgroundColor" to "rgba(0,0,0,0.3)", "zIndex" to 999)), "toast-content" to _pS(_uM("width" to 200, "height" to 150, "flexDirection" to "column", "justifyContent" to "center", "alignItems" to "center", "backgroundColor" to "#FFFFFF", "borderTopLeftRadius" to 16, "borderTopRightRadius" to 16, "borderBottomRightRadius" to 16, "borderBottomLeftRadius" to 16)), "toast-check" to _pS(_uM("fontSize" to 40, "color" to "#2ECC71", "marginBottom" to 8)), "toast-text" to _pS(_uM("fontSize" to 16, "color" to "#2C3E50", "textAlign" to "center", "paddingTop" to 0, "paddingRight" to 16, "paddingBottom" to 0, "paddingLeft" to 16)))
            }
