...
open class GenComponentsLineChart : VueComponent {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("chart-wrapper" to _pS(_uM("flexDirection" to "column", "width" to "100%", "backgroundColor" to "rgba(0,0,0,0)", "borderTopLeftRadius" to 10, "borderTopRightRadius" to 10, "borderBottomRightRadius" to 10, "borderBottomLeftRadius" to 10, "paddingTop" to 8, "paddingRight" to 8, "paddingBottom" to 4, "paddingLeft" to 8)), "chart-title" to _pS(_uM("paddingTop" to 0, "paddingRight" to 4, "paddingBottom" to 4, "paddingLeft" to 4)), "chart-title-text" to _pS(_uM("fontSize" to 13, "fontWeight" to "bold", "color" to "#FFFFFF")), "chart-legend" to _pS(_uM("flexDirection" to "row", "paddingTop" to 0, "paddingRight" to 4, "paddingBottom" to 6, "paddingLeft" to 4)), "legend-item" to _pS(_uM("flexDirection" to "row", "alignItems" to "center", "marginRight" to 16)), "legend-dot" to _pS(_uM("width" to 10, "height" to 10, "borderTopLeftRadius" to 5, "borderTopRightRadius" to 5, "borderBottomRightRadius" to 5, "borderBottomLeftRadius" to 5, "marginRight" to 4)), "legend-text" to _pS(_uM("fontSize" to 11, "color" to "rgba(255,255,255,0.72)")), "chart-area" to _pS(_uM("flexDirection" to "row", "width" to "100%")), "y-axis" to _pS(_uM("width" to 32, "flexDirection" to "column", "justifyContent" to "space-between", "alignItems" to "flex-end", "paddingRight" to 4)), "y-tick" to _pS(_uM("fontSize" to 9, "color" to "rgba(255,255,255,0.56)")), "plot-scroll" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "flexDirection" to "row")), "plot-area" to _pS(_uM("position" to "relative")), "grid-area" to _pS(_uM("position" to "absolute", "top" to 0, "left" to 0, "right" to 0, "bottom" to 0, "flexDirection" to "column", "justifyContent" to "space-between")), "grid-line" to _pS(_uM("width" to "100%", "height" to 1, "backgroundColor" to "rgba(255,255,255,0.12)")), "series-layer" to _pS(_uM("position" to "absolute", "top" to 0, "left" to 0, "right" to 0, "bottom" to 0)), "point-col" to _pS(_uM("position" to "absolute", "width" to 40, "alignItems" to "center", "flexDirection" to "column", "marginLeft" to -20)), "point-label" to _pS(_uM("fontSize" to 10, "fontWeight" to "bold", "marginBottom" to 2)), "point" to _pS(_uM("width" to 12, "height" to 12, "borderTopLeftRadius" to 6, "borderTopRightRadius" to 6, "borderBottomRightRadius" to 6, "borderBottomLeftRadius" to 6, "borderTopWidth" to 2, "borderRightWidth" to 2, "borderBottomWidth" to 2, "borderLeftWidth" to 2, "borderTopColor" to "rgba(255,255,255,0.85)", "borderRightColor" to "rgba(255,255,255,0.85)", "borderBottomColor" to "rgba(255,255,255,0.85)", "borderLeftColor" to "rgba(255,255,255,0.85)", "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid")), "x-axis" to _pS(_uM("height" to 26, "width" to "100%", "flexDirection" to "row", "marginLeft" to 36, "overflow" to "hidden")), "x-scroll" to _pS(_uM("width" to "100%", "flexDirection" to "row")), "x-track" to _pS(_uM("height" to 26, "position" to "relative")), "x-tick" to _pS(_uM("position" to "absolute", "fontSize" to 9, "color" to "rgba(255,255,255,0.56)", "width" to 40, "textAlign" to "center", "marginLeft" to -20)))
            }
